...
namespace Photon.LoadBalancing.MasterServer
{
    ...
    public class MasterClientPeer : PeerBase, ILobbyPeer
    {
        ...
        // CUSTOM
        private LogicOperationHandler logicOperationHandler;
            ...
            : base(initRequest.Protocol, initRequest.PhotonPeer)
        {
            ...
            // CUSTOM
            //TODO Looking at this again I'm guessing this will only work while user is NOT in a match
            this.logicOperationHandler = new LogicOperationHandler();
